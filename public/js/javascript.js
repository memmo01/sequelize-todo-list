...
function dataToPage(id,action,divId,buttonClass,buttonName,buttonStyle){
    var row = "<div class='col-lg-12'><ul class='list-group'>";
            row +="<li class='list-group-item'>"+action+"</li><li class='list-group-item'><button type='button' class='btn btn-"+buttonStyle+" btn-lg btn-block "+buttonClass+"' data-id="+id+">"+buttonName+"</button></li>";
            row+="</ul></div>";         
